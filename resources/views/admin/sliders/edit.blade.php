        ...
        <form action="{{ route('slider.update', $slider->id) }}" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6"> 
                        <div class="form-group mb-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{$slider->name}}" placeholder="Nhập Tiêu Đề">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group mb-6">
                            ...
                            <input type="text" class="form-control" name="url" id="url"  value="{{$slider->url}}" placeholder="Nhập URL">
                        </div>
                    </div>
                </div>
                ...
                <div class=" mb-6">
                    ...
                    <input type="number" name="sort_by" class="form-control"  value="{{$slider->sort_by}}" id="sort_by" value="1">
                </div>
