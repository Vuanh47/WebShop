    ...
    <!-- Header Area End Here -->
            ...
            <div class="product-area pt-55 pb-25 pt-xs-50">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="li-product-tab" style="display: flex; justify-content: center; align-items: center;">
                                <button class="scroll-left" onclick="scrollLeft()" style="background-color: transparent; border: none; font-size: 24px; cursor: pointer; position: absolute; left: 0; top: 50%; transform: translateY(-50%); z-index: 1;">&#10094;</button>
                                <ul class="nav li-product-menu" style="display: flex; overflow-x: auto; white-space: nowrap; padding: 0; margin: 0; list-style: none;">
                                    @foreach ($menus as $menu)
                                        <li style="margin-right: 10px;">
                                            <a class="{{ $loop->first ? 'active' : '' }}" data-toggle="tab" href="#li-{{ $menu->id }}">
                                                <span>{{ $menu->name }}</span>
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                                <button class="scroll-right" onclick="scrollRight()" style="background-color: transparent; border: none; font-size: 24px; cursor: pointer; position: absolute; right: 0; top: 50%; transform: translateY(-50%); z-index: 1;">&#10095;</button>
                            </div>
                            <!-- Phân trang -->
                            <div class="pagination">
                                {{ $menus->links() }} <!-- Hiển thị các liên kết phân trang -->
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="product-active owl-carousel">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('user/images/product/large-size/12.jpg')}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{asset('user/images/product/large-size/10.jpg')}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
