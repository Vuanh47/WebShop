...
<head>
        ...
        <!-- Favicon đặt một biểu tượng nhỏ (favicon) xuất hiện trên tab của trình duyệt -->
        <link rel="shortcut icon" type="image/x-icon" href="images/favicon.png">
        <!-- Material Design Iconic Font-V2.2.0  tập hợp các biểu tượng được thiết kế bởi Google.-->
        <link rel="stylesheet" href="{{asset('user/css/material-design-iconic-font.min.css')}}">
        <!-- Font Awesome biểu tượng phổ biến được sử dụng rộng rãi trên web. -->
        <link rel="stylesheet" href="{{asset('user/css/font-awesome.min.css')}}">
        <!-- Font Awesome Stars  hệ thống đánh giá sao.-->
        <link rel="stylesheet" href="{{asset('user/css/fontawesome-stars.css')}}">
        <!-- Meanmenu CSS giúp tạo các menu điều hướng -->
        <link rel="stylesheet" href="{{asset('user/css/meanmenu.css')}}">
        <!-- owl carousel CSS v (trình chiếu ảnh) đẹp mắt và dễ sử dụng.-->
        <link rel="stylesheet" href="{{asset('user/css/owl.carousel.min.css')}}">
        <!-- Slick Carousel CSS một thư viện khác để tạo các carousel với nhiều tùy chọn cấu hình. -->
        <link rel="stylesheet" href="{{asset('user/css/slick.css')}}">
        <!-- Animate CSS cung cấp các widget và hiệu ứng giao diện người dùng. -->
        <link rel="stylesheet" href="{{asset('user/css/animate.css')}}">
        <!-- Jquery-ui CSS  -->
        <link rel="stylesheet" href="{{asset('user/css/jquery-ui.min.css')}}">
        <!-- Venobox CSS  tạo các lightbox (hộp đèn) đáp ứng cho hình ảnh và video.-->
        <link rel="stylesheet" href="{{asset('user/css/venobox.css')}}">
        <!-- Nice Select CSS -- ung cấp các hộp chọn (select boxes) đẹp mắt và tùy chỉnh.-->
        <link rel="stylesheet" href="{{asset('user/css/nice-select.css')}}">
        <!-- Magnific Popup CSS tạo các popup responsive với nội dung hình ảnh hoặc video. -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="/index.php">
                                        <img style="width: 80px;" src="images/logoWeb-removebg-preview.png" alt="">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="shop-4-column.php">Shop</a></li>
                                ...
                                <div class="slider-active owl-carousel">
                                    ...
                                    <div class="single-slide align-center-left animation-style-02 bg-2">
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <h2>Work Desk Surface Studio 2024</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        <img style="width: 80px; height: 100%;" src ="images/logoFooter.png" alt="Footer Logo">
                                        <p class="info">
                                            We provide the most prestigious electronic products in Da Nang
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li>
                                            <span>Address: </span>
                                            Số 450 Đường Trần Đại Nghĩa, Điện Ngọc, Ngũ Hành Sơn, Đà Nẵng 550000
                                        </li>
                                        <li>
                                            <span>Phone: </span>
                                            <a href="#">(+84)328563246</a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a href="mailto://daovuanh2207@gmail.com">daovuanh2207@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
