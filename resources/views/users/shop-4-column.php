                                ...
                                <div class="tab-content">
                                    <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                        <div class="product-area shop-product-area">
                                            <div class="row">
                                                <?php 
                                                    $con = mysqli_connect("localhost","root","","shopdientu");
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                                <img src="images/product/large-size/<?php echo $row["img"]?>.jpg" alt="Li's Product Image">
                                                            </a>
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a href="product-details.php"><?php echo $row["category"]?></a>
                                                                    </h5>
                                                                ...
                                                                <h4><a class="product_name" href="single-product.php"><?php echo $row["nameproduct"]?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><?php echo $row["price"]?>VND</span>
                                                                </div>
                                                            </div>
