...
use App\Http\Service\CancelOrder\CancelOrderService;
...
class OrderController
{
    ...
    public function __construct(MenuService $menuService, CartService $cartService, ProductService $productService, OrderService $orderService, CancelOrderService $cancelOrderService)
    {
    ...
    public function cancelOrder(Request $request)
    {
        $validated = $request->validate([
            ...
            'other_cancel_reason' => 'nullable|string',
        ]);

        try {
            $result = $this->cancelOrderService->create($request);
            return redirect()->back()->with('success', 'Order cancellation request submitted successfully.');
        } catch (\Exception $e) {
    ...
    // Mail::to('admin@example.com')->send(new CancelOrderRequestMail($order));
